...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class FfmpegKitLibraryAccessors extends SubDependencyFactory {
        private final FfmpegKitFullLibraryAccessors laccForFfmpegKitFullLibraryAccessors = new FfmpegKitFullLibraryAccessors(owner);

        public FfmpegKitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at ffmpeg.kit.full
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public FfmpegKitFullLibraryAccessors getFull() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForFfmpegKitFullLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class FfmpegKitFullLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public FfmpegKitFullLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        @Deprecated
            ...
            /**
             * Creates a dependency provider for gpl (com.arthenica:ffmpeg-kit-full-gpl)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            ...
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("ffmpeg.kit.full.gpl");
        }

            /**
             * Creates a dependency provider for v4511 (com.arthenica:ffmpeg-kit-full)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
            public Provider<MinimalExternalModuleDependency> getV4511() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
                return create("ffmpeg.kit.full.v4511");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: ffmpegKitFullGpl (5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFfmpegKitFullGpl() { return getVersion("ffmpegKitFullGpl"); }

            /**
             * Returns the version associated to this alias: ffmpegKitFullVersion (4.5.1-1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getFfmpegKitFullVersion() { return getVersion("ffmpegKitFullVersion"); }
